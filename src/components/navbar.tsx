    ...
    >
      <div className="w-full px-4 md:px-6 flex justify-between items-center">
        ...
        <Link href="/" className="flex">
          ...
          />
          <div className="text-2xl font-bold bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent mt-[5px]">
            still in dev...
          </div>
        </Link>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex space-x-8">
            {["", "about", "projects", "contact", "blog", "timeline"].map(
              (section) => (
                <Link
                  key={section || "home"}
                  href={`/${section}`}
